  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="输入搜索：">
            <el-input v-model.trim="listQuery.id" class="input-width" clearable placeholder="订单号"></el-input>
          </el-form-item>
          ...
          <el-form-item label="操作人员：">
            <el-input v-model.trim="listQuery.handleMan" class="input-width" placeholder="全部" clearable></el-input>
          </el-form-item>
          ...
          <el-form-item label="用户账号：">
            <el-input v-model.trim="listQuery.userName" class="input-width" placeholder="用户账号" clearable></el-input>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
    ...
    <div class="table-container">
      <el-table ref="returnApplyTable"
        ...
        <el-table-column label="操作人员" width="120" align="center">
        ...
        <el-table-column label="退款金额" align="center">
         ...
         <el-table-column label="退款类型" width="100" align="center">
          <template slot-scope="scope">{{scope.row.typeb | formatType}}</template>
        </el-table-column>
        <el-table-column label="申请状态" width="110" align="center">
          <template slot-scope="scope">{{scope.row.status | formatStatus}}</template>
        </el-table-column>
        <el-table-column label="处理备注" width="180" align="center">
          <template slot-scope="scope">{{scope.row.handleNote}}</template>
        </el-table-column>
  ...
  export default {
    ...
    methods:{
      ...
      getList(){
        ...
        }else if(this.listQuery.handleMan==''){
          this.listQuery.handleMan==null
        }
