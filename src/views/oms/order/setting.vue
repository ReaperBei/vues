<template> 
  <el-card class="form-container" shadow="never">
    <el-form :model="orderSetting"
      ...
      <el-form-item label="未支付订单超时：" prop="normalOrderOvertime">
        <el-input v-model="orderSetting.noPayOrderOvertime" class="input-width">
          <template slot="append">分</template>
        </el-input>
        <span class="note-margin">未付款，订单自动关闭</span>
      </el-form-item>
      ...
      <el-form-item label="未提货过期时间：" prop="expirationTime">
        <el-input v-model="orderSetting.expirationTime" class="input-width">
          <template slot="append">天</template>
        </el-input>
        <span class="note-margin">过期时间</span>
      </el-form-item>
    ...
    data() {
      return {
        ...
        rules: {
          ...
          noPayOrderOvertime:{validator: checkTime, trigger: 'blur' },
          expirationTime:{validator: checkTime, trigger: 'blur' }
        }
      }
    },
    created(){
