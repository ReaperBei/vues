  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="输入搜索：">
            <el-input v-model.trim="listQuery.orderSn" clearable class="input-width" placeholder="订单编号"></el-input>
          </el-form-item>
          <el-form-item label="收货人：">
            <el-input v-model.trim="listQuery.receiverKeyword" class="input-width" placeholder="收货人姓名/手机号码" clearable></el-input>
          </el-form-item>
          ...
          <el-form-item label="门店编码：">
            <el-input v-model.trim="listQuery.storeSn" class="input-width" placeholder="门店编码" clearable></el-input>
          </el-form-item>
          <el-form-item label="门店名称：">
            <el-input v-model.trim="listQuery.storeName" class="input-width" placeholder="门店名称" clearable></el-input>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
    ...
    <div class="table-container">
      <el-table ref="orderTable"
        ...
        <el-table-column label="收货人姓名" width="120" align="center">
          <template slot-scope="scope">{{scope.row.receiverName}}</template>
        </el-table-column>
        <el-table-column label="收货人电话" width="120" align="center">
          <template slot-scope="scope">{{scope.row.receiverPhone}}</template>
        </el-table-column>
        <el-table-column label="门店编码" width="240" align="center">
          <template slot-scope="scope">{{scope.row.storeSn}}</template>
        </el-table-column>
        ...
        <el-table-column label="订单分类" width="120" align="center">
