  ...
  <div class="detail-container">
    ...
    <el-card shadow="never" style="margin-top: 15px">
      <div class="operate-container">
        ...
        <div class="operate-button-container" v-show="order.status===1010">
        ...
        <div class="operate-button-container" v-show="order.status===1020">
          <el-button size="mini" @click="showUpdateReceiverDialog">修改收货人信息</el-button>
          <el-button size="mini" @click="showMessageDialog">发送站内信</el-button>
          <el-button size="mini">取消订单</el-button>
          <el-button size="mini" @click="showMarkOrderDialog">备注订单</el-button>
        </div>
        <div class="operate-button-container" v-show="order.status===1030||order.status===1040||order.status===1050||order.status===1060">
          <el-button size="mini" @click="showLogisticsDialog">订单跟踪</el-button>
          <el-button size="mini" @click="showMessageDialog">发送站内信</el-button>
          <el-button size="mini" @click="showMarkOrderDialog">备注订单</el-button>
        </div>
        <div class="operate-button-container" v-show="order.status===1080">
    ...
    <el-dialog title="修改收货人信息"
      ...
      <el-form :model="receiverInfo"
        ...
        <el-form-item label="所在区域：">
            <VDistpickeris v-model="defultAddress" @change="change"></VDistpickeris>
        </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      change(data){
        this.receiverInfo.receiverProvince=data.province;
        this.receiverInfo.receiverCity=data.city;
        this.receiverInfo.receiverRegion=data.area;
      },
      formatTime(time) {
        if (time == null || time === '') {
          return '';
      ...
      showUpdateReceiverDialog(){
        ...
        this.defultAddress = {
            province:this.order.receiverProvince,
            city:this.order.receiverCity,
            area:this.order.receiverRegion
        };
        this.receiverInfo={
