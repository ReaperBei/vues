    ...
    <div class="table-container">
      <el-table ref="adminTable"
        ...
        <el-table-column label="业务号" width="200" align="center">
          <template slot-scope="scope">{{scope.row.businessNo}}</template>
        </el-table-column>
        <el-table-column label="会员ID" width="160" align="center">
          <template slot-scope="scope">{{scope.row.memberId}}</template>
        </el-table-column>
        <el-table-column label="消耗积分" width="160" align="center">
          <template slot-scope="scope">{{scope.row.resultIntegral}}</template>
        </el-table-column>
        <el-table-column label="得到股权" width="160" align="center">
          <template slot-scope="scope">{{scope.row.resultEquity}}</template>
        </el-table-column>
        <el-table-column label="申请积数" width="160" align="center">
...
<script>
  import {fetchList} from '@/api/applicationRecord';
