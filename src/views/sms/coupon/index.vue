  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="优惠券名称：">
            <el-input v-model.trim="listQuery.name" class="input-width" placeholder="优惠券名称" clearable></el-input>
          </el-form-item>
    ...
    <div class="table-container">
      <el-table ref="couponTable"
        ...
        <el-table-column label="优惠券生效时间" width="120" align="center">
          <template slot-scope="scope">{{scope.row.enableTime | formatDate}}</template>
        </el-table-column>
