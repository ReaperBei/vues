...
<script>
  import {handleStudentsAccount,handleStudentsBalance} from '@/api/students';
  ...
  export default {
    ...
    methods: {
      ...
      handleBalance(){
        handleStudentsBalance({collegeId:this.$route.query.id}).then(response => {
      ...
      getList() {
        ...
        handleStudentsAccount(this.listQuery).then(response => {
