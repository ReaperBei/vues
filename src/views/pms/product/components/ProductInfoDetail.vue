    ...
    data() {
      return {
        ...
        rules: {
          ...
          stock: [{required: true, validator:regular.FormValidate.Form().validateNumber, trigger: 'blur'}],
          weight: [{required: true, validator:regular.FormValidate.Form().validateNumber, trigger: 'blur'}]
        }
      };
    },
    created() {
    ...
    watch: {
      ...
      selectProductCateValue: function (newValue) {
        if (newValue != null && newValue.length === 2) {
          this.value.productCategoryIdTop = newValue[0];
